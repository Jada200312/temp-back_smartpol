...
export class DepartmentController {
  ...
  @ApiOperation({ 
    ...
    description: 'Returns the complete list of departments with their municipalities'
  })
  @ApiResponse({ 
    status: 200, 
  ...
  @ApiOperation({ 
    ...
    description: 'Delete a department and all its municipalities from the system'
  })
  @ApiResponse({ 
    status: 200, 
